...
public class TestClient1_1_PopulateRegion {
	...
	private void doTestCacheCreationStatus_Positive() {
		...
		String serverRegionCreationStatus = regionCreator.createServerRegion(regionName, regionOptions, pool);
		...
		serverRegionCreationStatus = regionCreator.createServerRegion(regionName, regionOptions, pool);
		assertEquals(ALREADY_EXISTS, serverRegionCreationStatus);
	...
	public void testRegionNameInvalidCharacter() {
		...
		try {
			remoteRegionCreationStatus = regionCreator.createServerRegion(regionName, regionOptions, pool);
			// both of the following are ok
